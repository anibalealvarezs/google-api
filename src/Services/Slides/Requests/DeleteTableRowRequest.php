...
/**
 * @see https://developers.google.com/slides/api/reference/rest/v1/presentations/request#DeleteTableRowRequest
 */
class DeleteTableRowRequest implements Jsonable
{
